@{
    ...
    FunctionsToExport    = @(
        ...
        'Get-MoveJournalPartitionDir',
        'Get-MoveJournalPartitionEntryPath',
        'Get-MoveJournalPath',
        ...
        'New-MoveItem',
        'New-MoveResult',
        'Read-MoveJournalPartitionEntries',
        'Read-ProjectXml',
        'Read-Solution',
        'Remove-MoveJournalEntry',
        'Remove-MoveJournalPartitionEntry',
        'Set-MoveJournalPartitionEntry',
        ...
        'Write-MoveJournalPartitionEntry',
        'Write-MovePlan',
